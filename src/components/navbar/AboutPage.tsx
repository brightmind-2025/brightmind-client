...
const AboutPage = () => {
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 text-gray-800 dark:text-white pt-26 ">
      ...
      <p className="text-lg text-center mb-8 text-gray-800 dark:text-white">
      ...
      <div className="space-y-6 text-lg text-gray-800 dark:text-white">
        <p className="text-gray-800 dark:text-white">
          ...
          Whether you&apos;re looking to upskill, explore new subjects, or
          deepen your expertise, our platform provides carefully curated courses
      ...
      <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg">
        <p className="text-lg text-gray-800 dark:text-white">
          Whether you&apos;re a <strong>student, a working professional</strong>
          , or simply passionate about gaining knowledge,
      ...
      <div className="mt-10 text-center text-gray-800 dark:text-white">
        <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">
          Take the First Step Towards Your Dream Career
        </h2>
        <p className="text-lg text-gray-800 dark:text-white">
          With <span className="font-bold text-yellow-400">BrightMind</span> by
          your side, there&apos;s nothing standing between you and your dream
        ...
        <p className="text-lg mt-4 text-gray-800 dark:text-white">
          <span className="text-yellow-400 font-bold">
            So what are you waiting for?
          </span>{" "}
          Join the BrightMind family today and let&apos;s conquer the
          programming industry together!
        </p>
      </div>

      <div className="mt-12 text-center text-gray-800 dark:text-white">
