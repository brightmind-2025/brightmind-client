export const styles = {
  ...
  label: "text-[16px] font-Poppins text-black dark:text-white rounded",
  input:
    "w-full text-black dark:text-white bg-transparent border rounded h-[40px] px-4 outline-none mt-[10px] font-Poppins",
  button:
